...
export default  {
    ...
    "loadCleanHtmlTemplate": loadCleanHtmlTemplate,
...
// replacements is expected to be a dictionary
function loadCleanHtmlTemplate(filename){
    var tmpl = '';

         if (fs.existsSync(filename)){
            tmpl = fs.readFileSync(filename).toString();
            tmpl = cleanHtmlTemplate(tmpl);
         }
         else{
            tmpl = 'html template not found: ' + filename;
         }
